...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $id = $_POST["id"];
    $result = $brand->remove($id);
    $message = $result ? "Brand removed successfully" : "Error removing brand";
}
?>
...
<body class="bg-gray-50">
    ...
    <main class="relative md:left-64 left-0 w-full md:w-[calc(100%-16rem)] md:ml-0 transition-all duration-300 ease-in-out p-5">
        ...
        <div class="flex justify-between items-center mb-8">
            <h2 class="text-3xl font-bold text-gray-800">Brands List</h2>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-500 truncate max-w-xs">
                                            <?php echo htmlspecialchars($brand['descripcion']); ?>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex space-x-3">
                                            <a class="text-blue-500 hover:text-blue-700" title="Edit"
                                                href="/<?php echo $lang; ?>/create-brand?id=<?php echo $brand['id']; ?>&action=edit">
                                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                </svg>
                                            </a>
                                            <form method="post" action="/<?php echo $lang; ?>/view-brands">
